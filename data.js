  ...
  heroes: [
    {
        ...
        "original": "Abrams",
        "translated": "エイブラムス",
        "image": "images/heroes/132-px_Abrams_card.png",
        ...
        "abilities": [
            {
                "name": "Siphon Life",
                "translated": "サイフォンライフ",
                "desc": "付近にいる敵からHPを奪ってSpiritDPSを与え、ダメージ量に応じてHPをHealingする / 【T3】範囲 +3m、DPS +18、スピリットスケーリングが上昇する",
                "scaling": {
                    "base": 22,
                    "spirit": 0.6
                }
            },
            {
                ...
                "desc": "前方に突撃し、ヒットした敵をPullingながら進む。ヒーローを壁に押し込むとStunを付与する突進中にヒーローにぶつかると、移動速度が上昇する / 【T1】3秒間スロウ+40%を付与 / 【T2】壁ヒット時：スタン時間+0.8秒 / 【T3】クールダウン-20秒ヒーロー衝突時：6秒間武器ダメージ+1.5",
                "scaling": {
                    "base": 30,
                    "spirit": 1.4
                }
            },
            {
                ...
                "desc": "防御性能が上昇する。受けたダメージ量に応じたRegenを一時的に得る / 【T3】デバフ耐性 +20%、被ダメージのリジェネ +8%",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                ...
                "desc": "空中に高く飛び上がり地面に勢いよく着地してSpiritDamageを与えStunを付与する / 【T3】発動時にアンストッパブルになる、衝撃範囲 +6m",
                "scaling": {
                    "base": 100,
                    "spirit": 2.325
                }
    ...
    },
    {
        ...
        "original": "Apollo",
        "translated": "アポロ",
        "image": "images/heroes/132px-Apollo_card.png",
        "description": "",
        "stats": {
            "maxHealth": 780,
            "bulletDamage": 18.5,
        ...
        "abilities": [
            ...
            },
            {
                ...
                "desc": "任意の方向に連続で突進し、前方を鋭い突きで攻撃する。アビリティキーを長押しすることで攻撃タイミングを調整でき、溜めが長いほどダメージが上昇する。ベストタイミングで攻撃を解放すると最大ダメージを与えるAbility3で再発動できる / 【T1】ヒーローへのパーフェクトヒット時：30回復 / 【T2】クールダウン -10秒。突進中は+60%の弾薬耐性を獲得する / 【T3】パーフェクトダメージ +65、スピリットスケーリングが上昇する突進攻撃のダッシュの速度と距離が上昇する",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                ...
                "desc": "チャージの後、長距離の斬撃を繰り出す。ヒットした敵は行動や回復ができずスローモーションとなる。この効果が終了した時、ヒットした敵は大ダメージを受ける。HPが半分以下の敵には与えるダメージが上昇するスローモーション中、アポロは無敵状態となり、敵は受けるダメージが低下するAbility4かAttackを長押しすることで発動を遅らせることができる / 【T3】IGNORED[]% Max Health Damage",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
    ...
    },
    {
        ...
        "original": "Bebop",
        "translated": "ビバップ",
        "image": "images/heroes/132px-Bebop_card.png",
        ...
        "abilities": [
            {
                ...
                "desc": "付近の敵にMeleeDamageを与えてKnockBackする敵が着地すると、SpiritDamageを与え、周辺の他の敵にReducedFireRateを付与するブラストアッパーカットは味方にも使用可能 / 【T2】ヒーローヒット時：武器のチャージ時間短縮、2倍の武器射程、武器ダメージ +40%を9秒間獲得する / 【T3】ヒーローヒット時：グラップルアームのクールダウンを0にし、減少HPの+17%を回復する",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                "name": "Sticky Bomb",
                "translated": "スティッキーボム",
                "desc": "ディレイ後に起爆するボムを取り付ける。ボムは爆発すると付近の敵にSpiritDamageを与えるヒーローに命中するかキルするたび、スティッキーボムが永続的な追加ダメージを得るスタックは60ヒットおよび7キルすると半減する / 【T3】発動時：5秒間、移動速度+5m／秒、発射速度 +20%",
                "scaling": {
                    "base": 85,
                    "spirit": 1.5
                }
            },
            {
                "name": "Grapple Arm",
                "translated": "グラップルアーム",
                "desc": "メカニカルハンドを発射し、最初に命中したキャラクターをつかんでPullsるグラップルアームは味方にも使用可能 / 【T1】6秒間、対象に与える武器ダメージが +20%",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                "name": "Hyper Beam",
                "translated": "ハイパービーム",
                "desc": "SpiritDamageを与えてSlow状態にする強力なエネルギーの奔流を放つ / 【T3】ハイパービームでヒーローに与えたダメージの 65%をBebopが回復する。非ヒーロー時は回復量が 20%になる",
                "scaling": {
                    "base": 160,
                    "spirit": 2.511
                }
    ...
    },
    {
        ...
        "original": "Billy",
        "translated": "ビリー",
        "image": "images/heroes/132px-Billy_card.png",
        "description": "",
        "stats": {
            "maxHealth": 830,
            "bulletDamage": 6.3,
        ...
        "abilities": [
            {
                "name": "Bashdown",
                "translated": "バッシュダウン",
                "desc": "バットを地面に叩きつけ、敵をPullingて、MeleeDamageを与える叩きつけ時には衝撃波が生じ、敵にSpiritDamageを与えてKnockUpする / 【T1】クールダウン -10秒 / 【T2】チャージ +1、範囲 +2m / 【T3】チャージ時間 -2秒60%の近接強攻撃ダメージを与えるようになる",
                "scaling": {
                    "base": 35,
                    "spirit": 1.1
                }
            },
            {
                "name": "Rising Ram",
                "translated": "ライジング・ラム",
                "desc": "敵に頭から突進して、敵と一緒にビリー自身も空に打ち上げるヒット時にクールダウンが50%短縮される / 【T1】ヒット時：5秒間、WeaponDamage +25% / 【T3】ヒット時：最大HPの8% をSpiritDamageとして与える",
                "scaling": {
                    "base": 40,
                    "spirit": 1.9
                }
            },
            {
                "name": "Blasted",
                "translated": "ブラスト",
                "desc": "パッシブ：近接攻撃が命中すると弾薬を回復し、対象にレックド状態を7秒間付与する / 【T1】ブラスト状態中： BonusMoveSpeed +2.25m/秒 / 【T2】使用時にバッシュダウンのチャージ回数 +1、レックド状態の敵への弾薬ダメージ増幅 +7% / 【T3】近接攻撃時のHP増加 +50、スピリットスケーリングが上昇する",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                "name": "Chain Gang",
                "translated": "チェーンギャング",
                "desc": "付近の敵を鎖で自身につなぐ。鎖で拘束された敵は移動アビリティを使用できず、鎖を引こうとすると強力なSlowを受けるディレイ後に、全ての敵をビリーの元に引き寄せ、SpiritDamageを与える射線が短時間途切れると鎖は切れる / 【T1】+40% SpiritResist & BulletResist / 【T3】範囲 +5m引き寄せたヒーローにつき+1.3秒のアンストッパブル状態を獲得する",
                "scaling": {
                    "base": 120,
                    "spirit": 1
                }
    ...
    },
    {
        ...
        "original": "Calico",
        "translated": "キャリコ",
        "image": "images/heroes/132px-Calico_card.png",
        ...
        "abilities": [
            {
                "name": "Gloom Bombs",
                "translated": "グルームボム",
                "desc": "爆弾を複数投げる。爆弾はディレイ後に起爆し、SpiritDamageを与える複数の爆弾がヒットした敵は受けるダメージが 65%に低下する / 【T2】爆弾がバリアに対して +75ダメージを与える",
                "scaling": {
                    "base": 45,
                    "spirit": 0.644
                }
            },
            {
                ...
                "desc": "前方にダッシュした後、円形範囲内にいるすべての敵を斬りつけてMeleeDamageを与えるこのアビリティが1人以上のヒーローにヒットすると、HPを少しだけHealする / 【T2】3秒以内にヒーローをキルすると、+200ソウルを獲得する / 【T3】ダメージ+60、ヒーローヒット時：クールダウン回復50%",
                "scaling": {
                    "base": 40,
                    "spirit": 1.4
                }
            },
            {
                "name": "Ava",
                "translated": "アヴァ",
                "desc": "影と化してアヴァに憑依する。時間経過で増加するBonusMoveSpeedを獲得し、ミニマップ上に表示されなくなる敵ヒーローからダメージを受けると移動速度ボーナスがリセットされ、アヴァが短時間のクールダウン状態になる / 【T2】HPリジェネ+15、最大移動速度 +45% / 【T3】時間経過でダメージ増幅を獲得し、最大20%まで増加する。効果は6秒間持続する",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                ...
                "translated": "シャドウバースト",
                "desc": "瞬時に影へと姿を変えて対象指定不可状態になり、BonusMoveSpeedを得てSpiritDamageを与えるディレイの後、影から戻って再びSpiritDamageを与える / 【T2】ダメージ +65、移動速度 +20% / 【T3】終了時：350回復し、すべてのアビリティのクールダウンを回復する",
                "scaling": {
                    "base": 140,
                    "spirit": 0.609336
                }
    ...
    },
    {
        ...
        "original": "Celeste",
        "translated": "セレステ",
        "image": "images/heroes/132px-Celeste_card.png",
        "description": "",
        "stats": {
            "maxHealth": 790,
            "bulletDamage": 22,
        ...
        "abilities": [
            {
                "name": "Light Eater",
                "translated": "ライトイーター",
                "desc": "前方の扇形範囲にいる敵を閃光で攻撃する。ヒットした敵は、Celesteの武器で攻撃されるとSpiritDamageを受け、スピリットライフスティールが発生する / 【T2】クールダウン -10秒、キャスト範囲 +3m / 【T3】ダメージ +25、スピリットスケーリングが上昇する",
                "scaling": {
                    "base": 20,
                    "spirit": 0.28
                }
            ...
            },
            {
                ...
                "desc": "空から降り注ぐ光のビームを呼び寄せる。短いディレイの後、ビームが完全に形成され、範囲内にいるすべての対象にSpiritDamageを与える爆発を発生させるこのアビリティが敵ヒーローにヒットするたび、スピリットダメージを上昇させるバフのスタックをセレステが獲得する / 【T2】クールダウン -18秒、着弾ダメージ +70",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                ...
                "desc": "SpiritDamageを与える光のオーブを発射する。光のオーブは着弾時にSlowを付与し、ダッシュ距離を減少させる。その後オーブは範囲内の敵に跳ね返る。対象がいない場合、オーブは短時間その場に留まり、対象を探し続ける対象が複数いる場合、敵ヒーローが優先される / 【T1】移動速度 -20%、ダッシュ距離 -15% / 【T3】最大バウンド回数 +8、クールダウン -35秒",
                "scaling": {
                    "base": 105,
                    "spirit": 0.63
                }
    ...
    },
    {
        ...
        "original": "Drifter",
        "translated": "ドリフター",
        "image": "images/heroes/132px-Drifter_card.png",
        "description": "",
        "stats": {
            "maxHealth": 765,
            "bulletDamage": 19.5,
        ...
        "abilities": [
            {
                "name": "Rend",
                "translated": "クロー",
                "desc": "前方の扇形範囲を攻撃し、範囲内の敵にSpiritDamageを与える。敵が至近距離内にいる場合、MeleeDamageを追加で与える / 【T2】クールダウン -7秒 / 【T3】至近距離内にいる敵を2.3秒間サイレンス状態にする",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                "name": "Stalker's Mark",
                "translated": "追跡者の刻印",
                "desc": "最初にヒットした対象を出血させ、SpiritDPSを与えるマークを放つ敵が出血している間に追跡者の刻印を再発動すると、その敵の背後に瞬間移動できる / 【T1】弾薬耐性 -8% / 【T2】クールダウン -8秒、継続時間 +3秒 / 【T3】出血ダメージ +2%、回復阻害 -40%",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            ...
            },
            {
                "name": "Eternal Night",
                "translated": "エターナルナイト",
                "desc": "付近の敵ヒーローを闇で包み込み、視界を大幅に制限する。効果を受けた敵は短い間マップ上に表示され、継続時間中は孤立状態とみなされるBonusSprintSpeedを獲得する / 【T3】継続時間 +2.5秒、最大対象数 +1",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
    ...
    },
    {
        ...
        "original": "Dynamo",
        "translated": "ダイナモ",
        "image": "images/heroes/132px-Dynamo_card.png",
        ...
        "abilities": [
            {
                "name": "Kinetic Pulse",
                "translated": "ストンプパルス",
                "desc": "地面を走るパルスを放ち、SpiritDamageを与えて敵をKnockUpする / 【T1】チャージ+1 / 【T2】ヒット時：弾薬耐性-18%、4秒間移動速度-30% / 【T3】ダメージ +135、キャスト範囲+20m",
                "scaling": {
                    "base": 115,
                    "spirit": 1.8
                }
            },
            {
                ...
                "desc": "一時的に対象指定不可となり、指定地点にテレポートする。発動時にスタミナを回復するAltCast：周辺の味方を同行させる / 【T3】アルティメットを除くデバフを解除するチャージアビリティのチャージを1回分回復する",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            ...
            },
            {
                "name": "Singularity",
                "translated": "シンギュラリティ",
                "desc": "特異点を生み出し、SpiritDPSを与えてStunを付与し、付近の敵を引き寄せる",
                "scaling": {
                    "base": 75,
                    "spirit": 0.28
                }
    ...
    },
    {
        ...
        "original": "Graves",
        "translated": "グレイブス",
        "image": "images/heroes/132px-Graves_card.png",
        "description": "",
        "stats": {
            "maxHealth": 740,
            "bulletDamage": 4,
        ...
        "abilities": [
            {
                "name": "Jar of Dead",
                "translated": "死者の魔瓶",
                "desc": "パッシブ：付近で何かがデスすると、死者の魔瓶に死を収集するアクティブ：魔瓶を投げてデッドヘッドを召喚する。デッドヘッドは敵に繰り返しSpiritDamageを与える付近に敵がいない場合、デッドヘッドはプレイヤーを追従し、武器の攻撃対象を優先する / 【T1】死を収集するたびにHPを5回復する / 【T2】継続時間 +4秒ヒット時：30%のスロウを1秒間付与 / 【T3】デッドヘッドの数 +2。デッドヘッドが生気吸収を発動するようになる",
                "scaling": {
                    "base": 20,
                    "spirit": 0.35
                }
            },
            {
                "name": "Grasping Hands",
                "translated": "グラスプハンド",
                "desc": "死者の手による壁を生成する。壁はSpiritDamageを与え、通ろうとした敵をImmobilize状態にするオルトキャスト AltCast で壁の方向を回転できる / 【T2】ダメージ +90、壁の長さ +10m / 【T3】1体のグールを召喚するクールダウン-10秒移動不能継続時間+1秒",
                "scaling": {
                    "base": 90,
                    "spirit": 1.6
                }
            },
            {
                "name": "Essence Theft",
                "translated": "生気吸収",
                "desc": "対象ごとに最大値まで、武器による攻撃がWeaponDamageとSpiritResistを敵から継続的に吸収し続ける / 【T3】武器のテザー +1本、テザーの追尾性能が向上する",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
    ...
    },
    {
        ...
        "original": "Grey Talon",
        "translated": "グレイタロン",
        "image": "images/heroes/132px-Grey_Talon_card.png",
        ...
        "abilities": [
            {
                "name": "Charged Shot",
                "translated": "チャージショット",
                "desc": "敵を貫通する強力なショットをチャージする。Ability1かAttack長押しでショットを溜めることができる / 【T2】ダメージ +54 / 【T3】ダメージスケールが増加し、アビリティチャージ時間が -3秒",
                "scaling": {
                    "base": 80,
                    "spirit": 1
                }
            },
            {
                "name": "Rain of Arrows",
                "translated": "レインアロー",
                "desc": "空中に高くジャンプして、ゆっくり滑空する。滑空中は武器ダメージが上昇し、武器がマルチショットになるAltCastでジャンプの高さを抑えられるMantleで滑空をキャンセル可能 / 【T2】滑空中の武器ダメージ +5、滑空中に武器ダメージを与えると 40%のスロウを 1.5秒間付与する / 【T3】滑空中、弾薬ライフスティール +30%、スピリットライフスティール +30%、弾薬回避 +30%",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            ...
            },
            {
                "name": "Guided Owl",
                "translated": "ガイドアウル",
                "desc": "1.5秒の詠唱後、操作可能なフクロウの精霊を放つ。フクロウは着弾時に爆発し、敵にダメージを与えてスタンを付与する。 MoveForward長押しでフクロウを加速可能Mantleで操作を解除する。ガイドアウルで敵をキルするたびに永続的なスピリットパワーを獲得する / 【T3】ヒット後、HPが 22%を下回る敵をキルする",
                "scaling": {
                    "base": 230,
                    "spirit": 0.93744
                }
    ...
    },
    {
        ...
        "original": "Haze",
        "translated": "ヘイズ",
        "image": "images/heroes/132px-Haze_card.png",
        ...
        "abilities": [
            ...
            },
            {
                "name": "Smoke Bomb",
                "translated": "スモークボム",
                "desc": "視界から消えてインビジブル状態になり、スプリント速度を獲得する。攻撃するとインビジブルが解除されるが、アイテム使用では解除されない。付近の敵はインビジブル状態を無視して姿を視認できる / 【T1】[AbilityCooldown]s Ability Cooldown / 【T2】アビリティチャージを 2回獲得 / 【T3】アルティメットを除くデバフを解除する5秒間、 +30%の弾薬ライフスティールを獲得する",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
    ...
    },
    {
        ...
        "original": "Holliday",
        "translated": "ホリデイ",
        "image": "images/heroes/132px-Holliday_card.png",
        ...
        "abilities": [
            {
                "name": "Powder Keg",
                "translated": "パウダーケグ",
                "desc": "ディレイ後に爆発するバレルを投げる。爆発したバレルはSpiritDamageを与え、敵をKnockUpするバレルは射撃、近接攻撃、射出または他のバレルによる爆発により早めに起爆できる / 【T3】ノックアップ +0.4秒、チャージ +2",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            ...
            },
            {
                "name": "Spirit Lasso",
                "translated": "スピリットラッソ",
                "desc": "ヒットした敵にSpiritDamageを与えて近くまでPulling、Stunを付与する投げ縄を投げるバウンスパッドを使うとスピリットラッソの継続時間が長くなる",
                "scaling": {
                    "base": 80,
                    "spirit": 0.93
                }
    ...
    },
    {
        ...
        "original": "Infernus",
        "translated": "インファーナス",
        "image": "images/heroes/132px-Infernus_card.png",
        ...
        "abilities": [
            {
                "name": "Napalm",
                "translated": "ナパーム",
                "desc": "可燃性の高い混合物を噴射する。SpiritDamageを与えてSlowを付与し、対象をナパームで覆う / 【T2】ナパームの効果：ライフスティール+15% / 【T3】ナパームの効果：被ダメージ +17%、敵の回復-33%",
                "scaling": {
                    "base": 40,
                    "spirit": 0.6
                }
            },
            {
                "name": "Flame Dash",
                "translated": "フレイムダッシュ",
                "desc": "SlowResistanceを得ながら前方にダッシュし、SpiritDPSを与える炎の道を残す発動中にMoveForwardを長押しするとより遠くまでダッシュできる / 【T2】炎の道の継続時間 +1秒、DPS +20 / 【T3】リチャージ時間が14秒のチャージを2個獲得する",
                "scaling": {
                    "base": 30,
                    "spirit": 1
                }
            },
            {
                "name": "Afterburn",
                "translated": "アフターバーン",
                "desc": "武器によってデバフが蓄積し、燃焼効果を付与する。燃焼効果はSpiritDPSを与えるアビリティによって燃焼効果の基礎継続時間が更新される / 【T2】燃焼効果：スピリットダメージ -35% / 【T3】燃焼 最大継続時間 +3秒間",
                "scaling": {
                    "base": 14,
                    "spirit": 0.66
                }
            },
            {
                ...
                "translated": "スタンバースト",
                "desc": "人間爆弾となってSpiritDamageを与え、ディレイの後に付近の敵すべてをStunにするスタンバーストは一度発動すると中断できない / 【T2】クールダウン -75秒、爆発ライフスティール+100% / 【T3】スタン継続時間 +0.75秒、範囲 +10m",
                "scaling": {
                    "base": 125,
                    "spirit": 0.974938
                }
    ...
    },
    {
        ...
        "original": "Ivy",
        "translated": "アイビー",
        "image": "images/heroes/132px-Ivy_card.png",
        ...
        "abilities": [
            ...
            },
            {
                "name": "Air Drop",
                "translated": "エアドロップ",
                "desc": "味方をつかみ共に飛行する。味方を落とすとSpiritDamageを与える爆発を発生させる。飛行終了時に自分と味方は、与えるダメージが上昇するバフを獲得する味方に使用した場合はクールダウンが25%短縮されるダメージを受けると、短時間アビリティを使用できなくなる飛行中、味方は射撃できず、与えるダメージが-20%になる / 【T1】飛行終了時：Ivyと味方が300のバリアを獲得、このバリアはスピリットでスケールする / 【T2】ヒットした敵に3秒間、+40%のスロウを付与 / 【T3】ヒットした敵に3秒間、サイレンスを付与ダメージとバリアのスケーリングが上昇する",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
    ...
    },
    {
        ...
        "original": "Kelvin",
        "translated": "ケルビン",
        "image": "images/heroes/132px-Kelvin_card.png",
        ...
        "abilities": [
            {
                ...
                "desc": "爆発時に大量の氷を噴出するグレネードを投げる。この氷は味方をHealsし、敵にはSpiritDamageを与えて移動速度低下を付与する / 【T1】ダメージ +30、回復量+30 / 【T2】クールダウン-10秒、デバフがスタミナリジェネを停止させる / 【T3】範囲+2m、ダメージと回復のスピリットスケーリングが上昇する",
                "scaling": {
                    "base": 60,
                    "spirit": 0.7
                }
            },
            {
                "name": "Ice Path",
                "translated": "アイスパス",
                "desc": "Kelvinが氷雪でできた道を空中に作る。道は自身と味方に移動速度ボーナスを付与する。この間、ケルビンはスロウ耐性を60% 獲得。この道は敵も使用可能アイスパス作成中に Roll ／ Crouchを押すと上下に操作可能 / 【T1】アイスパス上にいるKelvinが移動速度+2m／秒、弾薬耐性+35% / 【T3】アイスパス上にいるKelvinのスピリット+35%、スピリット+20",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            ...
            },
            {
                ...
                "desc": "自身またはヒーローを対象に、空気を凍らせてその周囲に侵入不可能なドームを作る。ドーム内では味方は高速のRegenを獲得し、敵はスロウ状態になるフローズンシェルター内ではオブジェクトが無敵状態となり、凍結する / 【T3】自身と味方の非アルティメットのデバフを解除するHPリジェネ +65、HPリジェネがスピリットでスケールするようになる",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
    ...
    },
    {
        ...
        "original": "Lady Geist",
        "translated": "レディガイスト",
        "image": "images/heroes/132px-Lady_Geist_card.png",
        ...
        "abilities": [
            ...
            },
            {
                "name": "Life Drain",
                "translated": "ライフドレイン",
                "desc": "継続的に敵のHPを吸収し、自身を回復するテザーを発生させる。対象は視界内かつ吸収範囲内にいる必要がある。発動中、射撃や他のアビリティは使用可能だが、移動速度が低下する AltCast で味方ヒーローにHPを与える / 【T3】チャージアビリティになり+2チャージを獲得、スピリットスケーリングが上昇する",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
    ...
    },
    {
        ...
        "original": "Lash",
        "translated": "ラッシュ",
        "image": "images/heroes/132px-Lash_card.png",
        ...
        "abilities": [
            ...
            },
            {
                "name": "Flog",
                "translated": "ウィップ",
                "desc": "目の前の敵をムチで攻撃し、与えたダメージに応じてHPをHealingする / 【T1】-35%移動速度を3秒間付与 / 【T2】-30%の発射速度を付与クールダウン-16秒 / 【T3】ダメージ+80攻撃角度+40回復+20%",
                "scaling": {
                    "base": 65,
                    "spirit": 0.85
                }
            },
            {
                "name": "Death Slam",
                "translated": "デススラム",
                "desc": "敵にフォーカスしてムチをつなげる。詠唱後、ムチでつながった敵を持ち上げてスタン状態を付与し、地面に叩きつける。対象と着地地点にいた敵にはダメージとスロウを与えるAttackを押すと早めに敵を持ち上げる。ムチをつないだ後に射線から外れた敵や範囲外に移動した敵は捕まえられない / 【T3】範囲内の敵を1.2秒間スタンさせるキャスト範囲+6m",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
    ...
    },
    {
        ...
        "original": "McGinnis",
        "translated": "マクギニス",
        "image": "images/heroes/132px-McGinnis_card.png",
        ...
        "abilities": [
            {
                "name": "Mini Turret",
                "translated": "ミニタレット",
                "desc": "敵を射撃してSpiritDPSを与えるタレットを配置する。このタレットは一定時間後に消滅するトルーパーやオブジェクトに対するタレットのダメージは減少する / 【T1】タレットDPS +10、攻撃範囲 +10m / 【T3】タレット発射速度 +30%、タレット継続時間 +12秒",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                ...
                "desc": "付近の味方のHPをHealingするガジェットを展開する / 【T1】ガジェットが+40%のスピリット耐性を付与する / 【T2】クールダウン -20秒、+100%のスタミナ回復を付与 / 【T3】最大HPリジェネ／秒 +2%、回復範囲 +3m、継続時間 +1.5秒",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                ...
                "desc": "通り抜けた敵にスロウを付与する壁を生成する。生成された壁は地形を分断し、付近にいる敵にダメージを与えるキャスト後、AttackかAbility3を押すと早めに壁を生成できる壁は近接攻撃で破壊できる / 【T1】ヒットした敵に対してMcGinnisの与えるダメージが、7秒間+20% / 【T2】クールダウン -20秒、継続時間 +2秒 / 【T3】壁の近くに2個のミニタレットを8秒間設置するスロウ +30%",
                "scaling": {
                    "base": 60,
                    "spirit": 0.731203
                }
    ...
    },
    {
        ...
        "original": "Mina",
        "translated": "ミナ",
        "image": "images/heroes/132px-Mina_card.png",
        "description": "",
        "stats": {
            "maxHealth": 670,
            "bulletDamage": 7.31,
        ...
        "abilities": [
            {
                "name": "Rake",
                "translated": "レーキ",
                "desc": "アクティブ：傘で切りつけてSpiritDamageを与える。このダメージは減少HPに応じて上昇する。対象をキルするたび、HPをHealするパッシブ：ADSを長押しすると少しだけ浮遊できるレーキはHPが60未満の非ヒーローを処刑する / 【T2】キルによる回復 +30クールダウン -8秒 / 【T3】減少HPに応じたダメージ +7%、キルによる回復のスピリットスケーリングが上昇する",
                "scaling": {
                    "base": 60,
                    "spirit": 0
                }
            ...
            },
            {
                "name": "Love Bites",
                "translated": "ラヴファング",
                "desc": "弾薬とアビリティがSpiritDamageを与える。一定量蓄積するとBonusSpiritDamageが発生するラヴファングは対象ごとに個別のクールダウンを持つ / 【T1】プロック時：3秒間スロウ +30% / 【T2】ダメージ +3追加ダメージ+45% / 【T3】クールダウン -4秒プロック時：5秒間、発射速度 +25%",
                "scaling": {
                    "base": 4,
                    "spirit": 0.09
                }
            },
            {
                ...
                "desc": "アクティブ：対象を追跡するコウモリの群れを放つ。コウモリはそれぞれSpiritDamageを与え、Silence状態を付与するパッシブ：ヒーローに対してラヴファングを発動させると、放つコウモリの数が永続的に増加する / 【T3】ヒット時：現在HPの+1%をダメージとして与える",
                "scaling": {
                    "base": 4.75,
                    "spirit": 0.1
                }
    ...
    },
    {
        ...
        "original": "Mirage",
        "translated": "ミラージュ",
        "image": "images/heroes/132px-Mirage_card.png",
    ...
    },
    {
        ...
        "original": "Mo & Krill",
        "translated": "モー＆クリル",
        "image": "images/heroes/132px-Mo_&_Krill_card.png",
        ...
        "abilities": [
            ...
            },
            {
                "name": "Burrow",
                "translated": "穴掘り",
                "desc": "地中に潜って素早く移動し、スピリットアーマーと弾薬アーマーを獲得する。敵ヒーローからダメージを受けると速度ボーナスが低下する地上に飛び出す際にSpiritDamageを与え、Slowを付与して敵をKnockUpする / 【T1】スピンDPS +50 / 【T2】穴掘り継続時間+4秒、範囲 +2m / 【T3】クールダウン -20秒、移動速度 +4m／秒",
                "scaling": {
                    "base": 75,
                    "spirit": 1.488
                }
    ...
    },
    {
        ...
        "original": "Paige",
        "translated": "ペイジ",
        "image": "images/heroes/132px-Paige_card.png",
        "description": "",
        "stats": {
            "maxHealth": 690,
            "bulletDamage": 35,
        ...
        "abilities": [
            {
                "name": "Bookwyrm",
                "translated": "ブックドラゴン",
                "desc": "指定地点にドラゴンを召喚し、前方へ飛ばす。このドラゴンはSpiritDamageを与え、通った後に炎の道を残す / 【T1】炎の道の継続時間 +2秒範囲 +1m / 【T2】飛行距離 +10mクールダウン -8秒 / 【T3】ダメージ +100DPS +30チャージ +1",
                "scaling": {
                    "base": 60,
                    "spirit": 1.3
                }
            },
            {
                "name": "Plot Armor",
                "translated": "プロットアーマー",
                "desc": "味方にCombatBarrierを付与する。バリアが維持されている間、味方はBonusWeaponDamageを得る / 【T1】バリア時：発射速度 +14% / 【T2】バリア +100、継続時間 +2秒 / 【T3】バリアスケーリングが上昇する最大2人の味方に追加で75%バリアを付与する",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                ...
                "desc": "魔法を仕掛ける範囲を指定し、Slowを付与する魔法はディレイの後に爆発し、SpiritDamageを与え、Immobilize状態にする / 【T3】範囲 +1mヒット時：6秒間、-18%スピリット耐性低下",
                "scaling": {
                    "base": 90,
                    "spirit": 1.3
                }
            },
            {
                ...
                "desc": "街全体を駆け抜ける幻影の騎士と騎馬の波を放つ。騎士は味方をHealingし、敵にはSpiritDamageを与えるHealとSpiritDamageの量は、騎士の移動距離に応じて増幅する / 【T2】騎馬の列幅が+4頭分増加クールダウン -30秒 / 【T3】ダメージ +135スタン継続時間 +0.5秒最大増幅 +50%",
                "scaling": {
                    "base": 125,
                    "spirit": 1
                }
    ...
    },
    {
        ...
        "original": "Paradox",
        "translated": "パラドックス",
        "image": "images/heroes/132px-Paradox_card.png",
        ...
        "abilities": [
            {
                "name": "Pulse Grenade",
                "translated": "パルスグレネード",
                "desc": "着弾時にパルスを放つグレネードを投げる。パルスのたびに範囲が広がり、SpiritDamageを与え、スローモーション状態とParadoxから対象へのDamageAmp（スタック可）を付与する / 【T2】パルスダメージ +20、スピリットスケーリングが上昇する / 【T3】ダメージ増幅 +4%、継続時間 +1.6秒",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            ...
            },
            {
                ...
                "desc": "強力な時間エネルギーをチャージして放つ。SpiritDamageを与え、ヒットした敵に時間停止効果を付与する。与えるダメージはWeaponDamageによって上昇する。チャージ中は移動速度が上昇する空中でのチャージ中、ADSで自分の動きを遅くすることができる / 【T3】チャージ継続時間 +2秒、最大ダメージスケール +50%",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
    ...
    },
    {
        ...
        "original": "Pocket",
        "translated": "ポケット",
        "image": "images/heroes/132px-Pocket_card.png",
        ...
        "abilities": [
            {
                "name": "Barrage",
                "translated": "バラージ",
                "desc": "着弾地点周辺の敵にSpiritDamageを与えて、Slowを付与する発射物を放つ。ヒーローにヒットした発射物は、PocketにスタックするDamageAmpを付与する空中で発動すると、Pocketは浮遊する空中ダッシュまたはフライングクロークを発動してもバラージはキャンセルされない / 【T3】増幅／スタック +4%、範囲 3m",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                ...
                "desc": "前進し続けるマントを飛ばす。マントは敵にダメージを与え、 Ability2 を押すとマントの位置にテレポートできる / 【T2】8秒間、武器ダメージ+5% / 【T3】生存時間 +1.6秒、クールダウン-14秒",
                "scaling": {
                    "base": 60,
                    "spirit": 1.3
                }
            },
            {
                ...
                "desc": "スーツケースの中に隠れる。潜伏時間終了時、付近にいる敵にSpiritDamageを与える。潜伏時間は、任意のアクションを行うことで早めに終了できる / 【T3】継続時間+1.5秒間範囲+4m4秒間、移動速度と発射速度-40%",
                "scaling": {
                    "base": 65,
                    "spirit": 0.9
                }
            },
            {
                "name": "Affliction",
                "translated": "アフリクション",
                "desc": "付近にいる敵にSpiritIcon継続ダメージを付与するアフリクションのダメージで敵をキルすることはできず、アイテムプロックは発生しない / 【T2】継続時間 +3秒、範囲 +4m / 【T3】すべての回復を無効化するDPS+18、スピリットスケーリングが上昇する",
                "scaling": {
                    "base": 34,
                    "spirit": 0.22
                }
    ...
    },
    {
        ...
        "original": "Rem",
        "translated": "レム",
        "image": "images/heroes/132px-Rem_card.png",
        "description": "",
        "stats": {
            "maxHealth": 690,
            "bulletDamage": 16,
        ...
        "abilities": [
            {
                "name": "Pillow Toss",
                "translated": "まくらなげ",
                "desc": "お気に入りの枕を投げてSpiritDamageを与え、大きくKnockBackさせる命中すると他のアビリティのクールダウンを短縮する / 【T2】範囲 +2、-35%の発射速度を付与 / 【T3】ダメージ +90、アビリティチャージ +1",
                "scaling": {
                    "base": 75,
                    "spirit": 1.6
                }
            },
            {
                "name": "Tag Along",
                "translated": "おひるね",
                "desc": "味方までジャンプし、そばで仮眠を取る。自身およびその味方は、減少HPに応じて一気にHPをHealし、持続するRegenを獲得する味方につき1度まで、Ability2で別の味方に飛びつくことで継続時間を更新できるアルティメットによるスタンを受けた場合は仮眠が解除されるアビリティ中はアイテムを使用でき、セルフキャストが味方を対象とするようになる / 【T2】仮眠中のアイテムの範囲、継続時間、バリア効果量が上昇 / 【T3】仮眠中と覚醒後の短い時間、ボーナススピリットパワーを獲得",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                "name": "Lil Helpers",
                "translated": "おてつだい",
                "desc": "使い魔に簡単なお使いをさせる。使い魔は木箱の中身集めや、罪人の供物の使用、味方やトルーパーの補佐ができるヒーローの追従：SpiritResistを短い時間付与し、徐々に減衰するMoveSpeedを付与するトルーパーの追従：トルーパーに回復、ダメージ、耐性を付与し、おひるねの対象にできる。付近にヒーローがいない場合、トルーパーキルによるソウルはチーム内で分配されるおひるね中に発動できる。誰かに追従した後、使い魔は15.1秒間仮眠を取る / 【T1】使い魔 +1 / 【T2】スピリット耐性 +8%移動速度 +1.5m／秒 / 【T3】使い魔 +2トルーパーの与ダメージと耐性 +20%",
                "scaling": {
                    "base": 20,
                    "spirit": 0
                }
            },
            {
                "name": "Naptime",
                "translated": "おやすみのじかん",
                "desc": "壁や床を貫通する視線を前方に放つ。視線範囲内の敵はスロウ状態になってダッシュ距離が短くなり、移動アビリティが使えなくなる詠唱完了時に範囲内の敵は睡眠状態になる。その後、激しい頭痛と共に覚醒し、大きなSpiritDamageを与える / 【T1】覚醒時に敵のスタミナ -1、睡眠中の敵はスタミナが回復しない / 【T2】範囲 +3m、睡眠継続時間 +0.5秒 / 【T3】クールダウン -65秒詠唱中ダメージが減少し、アンストッパブル状態になる",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
    ...
    },
    {
        ...
        "original": "Seven",
        "translated": "セブン",
        "image": "images/heroes/132px-Seven_card.png",
    ...
    },
    {
        ...
        "original": "Shiv",
        "translated": "シヴ",
        "image": "images/heroes/132px-Shiv_card.png",
        ...
        "abilities": [
            ...
            },
            {
                "name": "Slice and Dice",
                "translated": "スライス＆ダイス",
                "desc": "前方にダッシュして、進路上にいる敵にダメージを与える。命中した敵は、SpiritResistが低下する。このデバフはスタックする / 【T2】スピリット耐性-8%ダッシュ距離+2m / 【T3】衝突ダメージ+50ヒットしたヒーローにつきクールダウン-2秒",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
    ...
    },
    {
        ...
        "original": "Silver",
        "translated": "シルバー",
        "image": "images/heroes/132px-Silver_card.png",
        "description": "",
        "stats": {
            "maxHealth": 840,
            "bulletDamage": 5.4,
        ...
        "abilities": [
            {
                "name": "Slam Fire",
                "translated": "スラムファイア",
                "desc": "武器を即座にリロードし、BonusFireRateを獲得する。一定回数、対象のHPに応じた追加WeaponDamageを与えるが、射撃精度が低下する / 【T3】全弾ヒットさせた場合、現在HPの+8%分のダメージを与える",
                "scaling": {
                    "base": 40,
                    "spirit": 0
                }
            ...
            },
            {
                ...
                "translated": "バインドボーラ",
                "desc": "SpiritDamageを与えるボーラを投げる。ボーラはSlowを付与し、移動アビリティやスタミナ、ジャンプの使用を無効化する / 【T3】アビリティクールダウン -5秒。ボーラが追加で2つの対象に連鎖する",
                "scaling": {
                    "base": 40,
                    "spirit": 1.6
                }
            },
            {
                "name": "Lycan Curse",
                "translated": "人狼の呪い",
                "desc": "パッシブ：ダメージを与えると血の渇望を生成する。生成量はHPが低いと増加する。血の渇望が最大になると、自動で人狼の呪いを発動するアクティブ：即座に変身し、MaxHealthが増加し、敵ヒーローに対してスタックするFireRateを獲得する。また、アビリティと武器がより凶暴なものに変化する / 【T1】弾薬＆スピリット耐性 +20% / 【T2】移動速度 +4 m／秒、HP増加 200 / 【T3】ヒーローキル時：アビリティ、継続時間、変身回復をリフレッシュ",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
        ...
        "abilities": [
            {
                ...
                "desc": "目の前にいるすべての敵にMeleeDamageを与え、与えたダメージに応じてHPをHealする。対象のHPが低いほど、与えるダメージが上昇する",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                "name": "Mauling Leap",
                "translated": "マウリングリープ",
                "desc": "前方に飛びかかり、最初にヒットした敵にMeleeDamageを与える。敵のBulletResistを低下させ、継続SpiritDamageを与える",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                "name": "Tail Whack",
                "translated": "テイルスマッシュ",
                "desc": "周囲の敵を強打してSpiritDamageを与える。ヒットした敵はディスアーム状態になり、短時間Slow状態になる / 【T3】デバフ継続時間 +1.5秒間",
                "scaling": {
                    "base": 45,
                    "spirit": 1.5
                }
    ...
    },
    {
        ...
        "original": "Sinclair",
        "translated": "シンクレア",
        "image": "images/heroes/132px-Sinclair_card.png",
        ...
        "abilities": [
            {
                "name": "Vexing Bolt",
                "translated": "ヴェックスボルト",
                "desc": " ダメージを与える魔法の雷を放つ。このダメージは移動中に上昇する。アシスタントがいる場合、アシスタントもヴェックスボルトを発動するが、ダメージは減少するAbility1 を押すと、クロスヘアに向かって雷を再誘導する / 【T1】ボルトが -25%の発射速度を 5秒間付与する / 【T3】最大ダメージ +126。アシスタントダメージ +50%",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                ...
                "desc": "指定地点にアシスタントを召喚する。アシスタントはプレイヤーが射撃するたびに攻撃して ダメージを与えるアシスタントがいるときに Ability2 を押すと、アシスタントと位置を交換できるスペクターアシスタントの発動時に武器をリロードする / 【T2】継続時間 +7、召喚距離 +5m / 【T3】発射速度 +60%、アシスタントダメージ +12.6",
                "scaling": {
                    "base": 15,
                    "spirit": 0.36
                }
    ...
    },
    {
        ...
        "translated": "ドアマン",
        "image": "images/heroes/132px-The_Doorman_card.png",
        "description": "",
        "stats": {
            "maxHealth": 765,
            "bulletDamage": 29.26,
        ...
        "abilities": [
            {
                "name": "Call Bell",
                "translated": "コールベル",
                "desc": "着弾時にSpiritDamageを与えるコールベルを投げる。コールベルは短いディレイ後に爆発し、追加のSpiritDamageを与える。この爆発を受けた敵は武器の精度が低下し、Slow状態になる射撃することで早めに起爆できる / 【T1】チャージ +1 / 【T2】着弾ダメージ +30爆発ダメージ +40 / 【T3】範囲 +4mベルの生存時間 +26秒スケーリングが上昇する",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            ...
            },
            {
                "name": "Luggage Cart",
                "translated": "キャリーカート",
                "desc": "SpiritDamageを与え、通路上の敵ヒーローをPullsるキャリーカートを送り出すAltCastでオルトキャストすると、味方ヒーローを対象にできる / 【T2】キャスト範囲 +20m壁衝突時のダメージ +75 / 【T3】クールダウン -15秒、壁衝突時に1.25秒の Stunを付与",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                "name": "Hotel Guest",
                "translated": "ホテルゲスト",
                "desc": "対象の肉体を、客としてバロネス・ホテルに送る。客は速やかに出口用エレベーターを目指す必要がある。エレベーターに到着すると元の場所に送り返されるバロネス・ホテルでの滞在費はSpiritDamageで支払われる。時間内にチェックアウトできなかった場合、追加のSpiritDamageが発生する / 【T1】スタミナ減少 1、クールダウン -25秒 / 【T2】ダメージ +150チェックアウト失敗時に+1.5秒スタン / 【T3】客がバロネス・ホテルに滞在中、アンストッパブル状態になるチェックアウト失敗時にクールダウン13秒",
                "scaling": {
                    "base": 75,
                    "spirit": 1
                }
    ...
    },
    {
        ...
        "original": "Venator",
        "translated": "ヴェナトル",
        "image": "images/heroes/132px-Venator_card.png",
        "description": "",
        "stats": {
            "maxHealth": 790,
            "bulletDamage": 8,
        ...
        "abilities": [
            {
                ...
                "translated": "聖別手榴弾",
                "desc": "爆発前にバウンドするグレネードを射出する。グレネードの爆発はWeaponDamageを与え、敵に火をつける燃えている対象は範囲内の敵にPureDamageを与え、回復量が減少する / 【T2】範囲 +1.5m、燃焼継続時間 +1秒 / 【T3】回復阻害 -20%、アビリティがチャージを獲得",
                "scaling": {
                    "base": 35,
                    "spirit": 0
                }
            },
            {
                "name": "Gutshot",
                "translated": "ガットショット",
                "desc": "ショットガンによる爆撃を放ってWeaponDamageを与え、敵を後方へとノックバックする。壁付近の敵はStun状態になり、BonusWeaponDamageを受ける / 【T2】アビリティクールダウン -10秒、スタン継続時間 +0.4秒 / 【T3】壁スタン時：次の近接強攻撃が祝福状態になる",
                "scaling": {
                    "base": 60,
                    "spirit": 0
                }
            },
            {
                ...
                "translated": "魔呪の狩猟罠",
                "desc": "短いディレイの後に作動状態になるトラップを蹴り飛ばすトラップは最初に触れた敵に飛びかかってSpiritDamageを与え、Immobilize状態を付与する。その後の一定時間、その敵は視認可能になる / 【T3】視認可能状態の対象に与えるダメージが+25%",
                "scaling": {
                    "base": 80,
                    "spirit": 2.2
                }
            },
            {
                "name": "Ira Domini",
                "translated": "イーラ・ドミニ",
                "desc": "クロスボウに杭を3本装填する。杭は大幅に増加したWeaponDamageを与える最後の杭は祝福状態となり、追加PureDamageを与え、HPの低い敵を処刑する / 【T1】アクティブ時：移動速度1.2m／秒を獲得 / 【T2】アビリティクールダウン -15秒、追加ダメージ +65 / 【T3】すべての杭が祝福される",
                "scaling": {
                    "base": 120,
                    "spirit": 0
                }
    ...
    },
    {
        ...
        "original": "Victor",
        "translated": "ビクター",
        "image": "images/heroes/132px-Victor_card.png",
        "description": "",
        "stats": {
            "maxHealth": 810,
            "bulletDamage": 12,
        ...
        "abilities": [
            {
                "name": "Pain Battery",
                "translated": "ペインバッテリー",
                "desc": "ダメージを受けると、ペインバッテリーが自動的に蓄積される蓄積が満タンの状態でアビリティを発動すると複数の電撃を放ち、それぞれの対象にSpiritDamageを与える / 【T1】ヒット時：2秒間スロウ40% / 【T3】ヒーローヒット時に失ったHPの15%を回復、スピリットスケーリングが上昇する",
                "scaling": {
                    "base": 100,
                    "spirit": 1.6
                }
            },
            {
                "name": "Jumpstart",
                "translated": "ジャンプスタート",
                "desc": "自身にSpiritDamageを与えた後に、追加のRegenとBonusMoveSpeedを得る。この効果は時間経過とともに減衰する / 【T2】合計HPリジェネ +50、クールダウン -8秒 / 【T3】チャージ +1デバフ耐性 +50%スピリットスケーリングが上昇する",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                ...
                "translated": "苦悶のオーラ",
                "desc": "苦痛を解き放ち、敵と自分の両方にSpiritDPSを与えるダメージはアビリティの発動時間が長いほど、上限に達するまで増加し続ける / 【T1】敵に30%のスロウを付与する / 【T2】最小DPS +6、最大DPS+23 / 【T3】敵の受けるダメージが+15% 増加する",
                "scaling": {
                    "base": 0,
                    "spirit": 1.1
                }
            },
            {
                ...
                "translated": "ショックリバイブ",
                "desc": "致死ダメージを受けた後に復活し、付近の敵にSpiritDamageを与えてStunを付与する / 【T1】クールダウン中：+15%の発射速度を獲得、弾薬ごとに6を与える / 【T3】ダメージ +150スタン +1.5秒クールダウン -100秒",
                "scaling": {
                    "base": 200,
                    "spirit": 2
                }
    ...
    },
    {
        ...
        "original": "Vindicta",
        "translated": "ヴィンディクタ",
        "image": "images/heroes/132px-Vindicta_card.png",
    ...
    },
    {
        ...
        "original": "Viscous",
        "translated": "ヴィスカス",
        "image": "images/heroes/132px-Viscous_card.png",
        ...
        "abilities": [
            ...
            },
            {
                "name": "The Cube",
                "translated": "ザ・キューブ",
                "desc": "回復力の高い粘液キューブで対象を包み込み、ダメージを防いでHPリジェネを上昇させる。キューブの中にいる間、対象はあらゆるアクションを行えない。自身にも使用可能。 Mantle を押すと早く脱出できる / 【T1】移動速度とスタミナ回復が上昇 / 【T2】HPリジェネ +25、継続時間 +1秒 / 【T3】使用時にすべてのデバフ（アルティメットを除く）を解除、クールダウン -25秒",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                "name": "Puddle Punch",
                "translated": "パドルパンチ",
                "desc": "範囲内にいるユニットをパンチしてKnockUpする拳を、指定地点に生成するヒットした敵にはMeleeDamageを与え、Slowを付与する自分と味方は、空中制御が上昇する / 【T2】範囲 +1.5m、ダメージ +30 / 【T3】クールダウン -12秒、近接強攻撃ダメージを与えるようになる",
                "scaling": {
                    "base": 20,
                    "spirit": 0
                }
    ...
    },
    {
        ...
        "original": "Vyper",
        "translated": "ヴァイパー",
        "image": "images/heroes/132px-Vyper_card.png",
        ...
        "abilities": [
            {
                ...
                "desc": "SpiritDamageを与え、Slowを付与するダガーを投げる同じ対象に連続してダガーを命中させると、SpiritDamageとSlowがスタックする / 【T2】ヒット時：弾薬耐性-8%、スタックごとに弾薬耐性-5% / 【T3】ヒット時：チャージのクールダウンを55%回復",
                "scaling": {
                    "base": 50,
                    "spirit": 0.8
                }
    ...
    },
    {
        ...
        "original": "Warden",
        "translated": "ウォーデン",
        "image": "images/heroes/132px-Warden_card.png",
    ...
    },
    {
        ...
        "original": "Wraith",
        "translated": "レイス",
        "image": "images/heroes/132px-Wraith_card.png",
        ...
        "abilities": [
            ...
            },
            {
                "name": "Full Auto",
                "translated": "フルオート",
                "desc": "一時的に発射速度を上昇させ、追加SpiritDamageを与える / 【T2】発射速度 +10%、継続時間 +3秒 / 【T3】弾数が無制限になる、弾薬ごとのスピリットダメージのスケーリングが増加",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
    ...
    },
    {
        ...
        "original": "Yamato",
        "translated": "ヤマト",
        "image": "images/heroes/132px-Yamato_card.png",
        ...
        "abilities": [
            {
                "name": "Power Slash",
                "translated": "パワースラッシュ",
                "desc": "1.4秒間の詠唱を行い、チャージ完了時に刀攻撃を放つ。ダメージは詠唱中に徐々に上昇するAbility1かAttackを押すと攻撃が早く発動するが、与えるダメージが減少する / 【T1】3秒間スロウ+40% / 【T2】アビリティクールダウン -4秒 / 【T3】キャスト範囲+8mダメージ+150、スピリットパワースケーリングが上昇",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
            },
            {
                ...
                "desc": "鉤縄を投げてヒットした敵に向かって飛びつき、対象に軽MeleeDamageを与えてスロウを付与する / 【T2】キャスト範囲 +20m、 6秒間スピリットパワー +40を獲得する / 【T3】味方ヒーローに飛びつき可能になる、チャージを1回獲得する",
                "scaling": {
                    "base": 0,
                    "spirit": 0
                }
    ...
    "weapon": [
        {
            ...
            "image": "images/items/30px-Close_Quarters.png",
            "price": 800,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "translated": "基礎拡張マガジン",
            "image": "images/items/30px-Extended_Magazine.png",
            "price": 800,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Headshot_Booster.png",
            "price": 800,
            "duration": "",
            "effects": [
            ...
            "description": "敵ヒーローへの次のヘッドショットが、BonusWeaponDamageを与える"
        },
        {
            "id": "upgrade_high_velocity_mag",
            "original": "High-Velocity Rounds",
            "translated": "ハイスピードラウンド",
            "image": "images/items/30px-High-Velocity_Rounds.png",
            "price": 800,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Monster_Rounds.png",
            "price": 800,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "translated": "ラピッドラウンド",
            "image": "images/items/30px-Rapid_Rounds.png",
            "price": 800,
            "duration": "",
            "effects": [
                "BonusFireRate: 15"
        ...
        },
        {
            ...
            "image": "images/items/30px-Restorative_Shot.png",
            "price": 800,
            "duration": "",
            "effects": [
                "HealFromHero: 100",
        ...
        },
        {
            ...
            "image": "images/items/30px-Active_Reload.png",
            "price": 1600,
            "duration": 7,
            "effects": [
                "BonusFireRate: 15",
            ...
            "description": "リロード中にハイライト部分でReloadを押すとリロードが一瞬で完了する。また、効果発動時に発射速度と移動速度が上昇し、弾薬ライフスティールを獲得する"
        },
        {
            "id": "upgrade_fleetfoot_boots",
            "original": "Fleetfoot",
            "translated": "フリートフット",
            "image": "images/items/30px-Fleetfoot.png",
            "price": 1600,
            "duration": 5,
            "effects": [
        ...
        },
        {
            ...
            "translated": "連射強化マガジン",
            "image": "images/items/30px-Intensifying_Magazine.png",
            "price": 1600,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Kinetic_Dash.png",
            "price": 1600,
            "duration": 7,
            "effects": [
                "BonusFireRate: 20",
            ...
            "description": "ダッシュジャンプ時に発射速度が上昇し、追加弾数を獲得する。この効果は次にリロードするまで、最大で[AbilityDuration]秒間継続する"
        },
        {
            "id": "upgrade_long_range",
            "original": "Long Range",
            "translated": "ロングレンジ",
            "image": "images/items/30px-Long_Range.png",
            "price": 1600,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "translated": "メレーチャージ",
            "image": "images/items/30px-Melee_Charge.png",
            "price": 1600,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Mystic_Shot.png",
            "price": 1600,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Opening_Rounds.png",
            "price": 1600,
            "duration": "",
            "effects": [
            ...
            "description": "HPが[EnemyLifeThreshold]%を上回る敵に対する攻撃が追加で武器ダメージを与える"
        },
        {
            "id": "upgrade_rechargingbullets",
            "original": "Recharging Rush",
            "translated": "リチャージラッシュ",
            "image": "images/items/30px-Recharging_Rush.png",
            "price": 1600,
            "duration": "",
            "effects": [
                "AbilityCooldown: -12",
            ...
            "description": "一定以上のWeaponDamageを与えると、チャージを持つアビリティそれぞれの使用回数が1回分回復する"
        },
        {
            "id": "upgrade_slowing_bullets",
            "original": "Slowing Bullets",
            "translated": "スロウバレット",
            "image": "images/items/30px-Slowing_Bullets.png",
            "price": 1600,
            "duration": "",
            "effects": [
                "BaseAttackDamagePercent: 30",
        ...
        },
        {
            ...
            "image": "images/items/30px-Spirit_Shredder_Bullets.png",
            "price": 1600,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Split_Shot.png",
            "price": 1600,
            "duration": "",
            "effects": [
                "BulletSplitShot: 4",
        ...
        },
        {
            ...
            "original": "Stalker",
            "translated": "ストーカー",
            "image": "images/items/30px-Stalker.png",
            "price": 1600,
            "duration": 5,
            "effects": [
            ...
            "description": "近距離でWeaponDamageを与えると傷を付与し、BonusMoveSpeedを獲得する傷状態の敵はSpiritDPSを受け、BulletResistが低下する。また、壁越しにその姿を視認できる"
        },
        {
            "id": "upgrade_blitz_bullets",
            "original": "Swift Striker",
            "translated": "スイフトストライカー",
            "image": "images/items/30px-Swift_Striker.png",
            "price": 1600,
            "duration": "",
            "effects": [
                "BonusFireRate: 15",
        ...
        },
        {
            ...
            "translated": "巨大拡張マガジン",
            "image": "images/items/30px-Titanic_Magazine.png",
            "price": 1600,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Weakening_Headshot.png",
            "price": 1600,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Alchemical_Fire.png",
            "price": 3200,
            "duration": 5,
            "effects": [
                "DPS: 30",
            ...
            "description": "接触時に爆発する瓶を投げる。生成されたエリア内にいる敵には増加するスピリットダメージを毎秒与え続け、弾薬耐性を低下させる非ヒーローには効果が[NonHeroReductionPercent]%減少する"
        },
        {
            "id": "upgrade_bulletshredimbue",
            "original": "Ballistic Enchantment",
            "translated": "バリスティックエンチャント",
            "image": "images/items/30px-Ballistic_Enchantment.png",
            "price": 3200,
            "duration": 14,
            "effects": [
        ...
        },
        {
            ...
            "original": "Berserker",
            "translated": "バーサーカー",
            "image": "images/items/30px-Berserker.png",
            "price": 3200,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Blood_Tribute.png",
            "price": 3200,
            "duration": "",
            "effects": [
            ...
            "description": "切り替え：継続的にHPを捧げることで、FireRateとデバフ耐性、移動速度が上昇する"
        },
        {
            "id": "upgrade_burst_fire",
            "original": "Burst Fire",
            "translated": "バーストファイア",
            "image": "images/items/30px-Burst_Fire.png",
            "price": 3200,
            "duration": 4.5,
            "effects": [
                "SlideScale: 50",
        ...
        },
        {
            ...
            "translated": "サクリファイス",
            "image": "images/items/30px-Cultist_Sacrifice.png",
            "price": 3200,
            "duration": 160,
            "effects": [
            ...
            "description": "敵NPC1体を対象にする。対象をキルして[BonusSoulsPct]%の追加ソウルを獲得し、長時間持続する強力なバフを獲得する"
        },
        {
            "id": "upgrade_reinforcing_casings",
            "original": "Escalating Resilience",
            "translated": "エスカレートレジリエンス",
            "image": "images/items/30px-Escalating_Resilience.png",
            "price": 3200,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Express_Shot.png",
            "price": 3200,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "original": "Headhunter",
            "translated": "ヘッドハンター",
            "image": "images/items/30px-Headhunter.png",
            "price": 3200,
            "duration": "",
            "effects": [
            ...
            "description": "敵ヒーローへの次のヘッドショットが、BonusWeaponDamageを与え、自身をHealし、BonusMoveSpeedを短時間付与する"
        },
        {
            "id": "upgrade_dps_aura",
            "original": "Heroic Aura",
            "translated": "ヒロイックオーラ",
            "image": "images/items/30px-Heroic_Aura.png",
            "price": 3200,
            "duration": 7,
            "effects": [
                "ActiveBonusMoveSpeed: 3m",
        ...
        },
        {
            ...
            "translated": "ホロウポイント",
            "image": "images/items/30px-Hollow_Point.png",
            "price": 3200,
            "duration": "",
            "effects": [
            ...
            "description": "自身のHPが[LifeThreshold]%を上回っている間、追加武器ダメージを与え、弾薬が敵の弾薬耐性を低下させる"
        },
        {
            "id": "upgrade_bullet_armor_reduction_aura",
            "original": "Hunter's Aura",
            "translated": "ハンターオーラ",
            "image": "images/items/30px-Hunter's_Aura.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "FireRateSlow: 5",
        ...
        },
        {
            ...
            "translated": "ポイントブランク",
            "image": "images/items/30px-Point_Blank.png",
            "price": 3200,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Sharpshooter.png",
            "price": 3200,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "translated": "スピリットキラー",
            "image": "images/items/30px-Spirit_Rend.png",
            "price": 3200,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "translated": "テスラバレット",
            "image": "images/items/30px-Tesla_Bullets.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "DamagePerChain: 25",
        ...
        },
        {
            ...
            "image": "images/items/30px-Toxic_Bullets.png",
            "price": 3200,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "translated": "ヘヴィショット",
            "image": "images/items/30px-Weighted_Shots.png",
            "price": 3200,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Armor_Piercing_Rounds.png",
            "price": 6400,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "original": "Capacitor",
            "translated": "コンデンサー",
            "image": "images/items/30px-Capacitor.png",
            "price": 6400,
            "duration": "",
            "effects": [
                "ProcChance: 5",
            ...
            "description": "SpiritIconダメージを与える発射物を射出する。発射物は時間経過で回復する強力なスロウを付与する。また、対象はスタミナが使用できなくなり、移動に関連するアイテムやアビリティがサイレンス状態になる"
        },
        {
            "id": "upgrade_banshee_slugs",
            "original": "Crippling Headshot",
            "translated": "クリップリングショット",
            "image": "images/items/30px-Crippling_Headshot.png",
            "price": 6400,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Crushing_Fists.png",
            "price": 6400,
            "duration": "",
            "effects": [
            ...
            "description": "MeleeDamageを与えると弾数を回復し、スタックする弾薬耐性デバフを1つ付与する。近接強攻撃は2スタック付与するスタックが最大数に達すると、対象はスタン状態になる"
        },
        {
            "id": "upgrade_fervor",
            "original": "Frenzy",
            "translated": "フレンジー",
            "image": "images/items/30px-Frenzy.png",
            "price": 6400,
            "duration": "",
            "effects": [
                "FervorFireRate: 20",
        ...
        },
        {
            ...
            "translated": "グラスキャノン",
            "image": "images/items/30px-Glass_Cannon.png",
            "price": 6400,
            "duration": "",
            "effects": [
                "FireRatePerKill: 8",
            ...
            "description": "ヒーローをキルするたび、永続的に発射速度が上昇する（最大[MaxStacks]スタック）。デスするとスタックを1つ失う"
        },
        {
            "id": "upgrade_critshot",
            "original": "Lucky Shot",
            "translated": "ラッキーショット",
            "image": "images/items/30px-Lucky_Shot.png",
            "price": 6400,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "original": "Ricochet",
            "translated": "リコシェ",
            "image": "images/items/30px-Ricochet.png",
            "price": 6400,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "translated": "シャドウウィーブ",
            "image": "images/items/30px-Shadow_Weave.png",
            "price": 6400,
            "duration": 18,
            "effects": [
        ...
        },
        {
            ...
            "original": "Silencer",
            "translated": "サイレンサー",
            "image": "images/items/30px-Silencer.png",
            "price": 6400,
            "duration": "",
            "effects": [
            ...
            "description": "弾薬がサイレンスを蓄積するようになる。サイレンス状態が終了した後の[ImmunityDuration]秒間、対象は蓄積の効果を受けない"
        },
        {
            "id": "upgrade_enchanted_holsters",
            "original": "Spellslinger",
            "translated": "スペルスリンガー",
            "image": "images/items/30px-Spellslinger.png",
            "price": 6400,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Spiritual_Overflow.png",
            "price": 6400,
            "duration": 15,
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Haunting_Shot.png",
            "price": "Legendary",
            "duration": "",
            "effects": [
                "GroundDashReductionPercent: -10",
            ...
            "description": "次に放たれる弾薬が、敵の与ダメージ、回復効果、移動速度を低下させる強力なデバフを付与する。さらに、対象の現在のHPに応じたBonusSpiritDamageも与える。この弾薬はサイズが大きく、対象を貫通する"
        },
        {
            "id": "upgrade_infinite_rounds",
            "original": "Infinite Rounds",
            "translated": "インフィニットラウンド",
            "image": "images/items/30px-Infinite_Rounds.png",
            "price": "Legendary",
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Runed_Gauntlets.png",
            "price": "Legendary",
            "duration": "",
            "effects": [
    ...
    "vitality": [
        {
            ...
            "translated": "エクストラヘルス",
            "image": "images/items/30px-Extra_Health.png",
            "price": 800,
            "duration": "",
            "effects": [
                "BonusHealth: 115"
        ...
        },
        {
            ...
            "image": "images/items/30px-Extra_Regen.png",
            "price": 800,
            "duration": "",
            "effects": [
                "BonusHealthRegen: 9"
        ...
        },
        {
            ...
            "image": "images/items/30px-Extra_Stamina.png",
            "price": 800,
            "duration": "",
            "effects": [
                "Stamina: 1",
        ...
        },
        {
            ...
            "image": "images/items/30px-Healing_Rite.png",
            "price": 800,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Melee_Lifesteal.png",
            "price": 800,
            "duration": "",
            "effects": [
            ...
            "description": "次の近接攻撃がHPを回復する非ヒーローに対しては回復量が[NonHeroHealPct]%に低下する近接弱攻撃の場合はクールダウンが[LightMeleeCooldownMult]倍になる"
        },
        {
            "id": "upgrade_melee_rebuttal",
            "original": "Rebuttal",
            "translated": "プロテスト",
            "image": "images/items/30px-Rebuttal.png",
            "price": 800,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "translated": "スプリントブーツ",
            "image": "images/items/30px-Sprint_Boots.png",
            "price": 800,
            "duration": "",
            "effects": [
                "OutOfCombatHealthRegen: 8",
        ...
        },
        {
            ...
            "translated": "バトルベスト",
            "image": "images/items/30px-Battle_Vest.png",
            "price": 1600,
            "duration": "",
            "effects": [
            ...
            "description": "自身のHPが[LifeThreshold]%を上回っている間、WeaponDamageとBonusFireRateを獲得する"
        },
        {
            "id": "upgrade_vampire",
            "original": "Bullet Lifesteal",
            "translated": "バレットライフスティール",
            "image": "images/items/30px-Bullet_Lifesteal_(item).png",
            "price": 1600,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Debuff_Reducer.png",
            "price": 1600,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "translated": "妖術師の紋章",
            "image": "images/items/30px-Enchanter's_Emblem.png",
            "price": 1600,
            "duration": "",
            "effects": [
                "TechResist: 13",
            ...
            "description": "自身のHPが[LifeThreshold]%を上回っている間、ボーナスSpiritを獲得し、クールダウンが短縮される"
        },
        {
            "id": "upgrade_cardio_calibrator",
            "original": "Enduring Speed",
            "translated": "ウィングブーツ",
            "image": "images/items/30px-Enduring_Speed.png",
            "price": 1600,
            "duration": "",
            "effects": [
                "SlowResistancePercent: 30",
        ...
        },
        {
            ...
            "image": "images/items/30px-Guardian_Ward.png",
            "price": 1600,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "original": "Healbane",
            "translated": "ヒールベイン",
            "image": "images/items/30px-Healbane.png",
            "price": 1600,
            "duration": 8,
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Healing_Booster.png",
            "price": 1600,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Reactive_Barrier.png",
            "price": 1600,
            "duration": 10,
            "effects": [
                "TechResist: 10",
        ...
        },
        {
            ...
            "image": "images/items/30px-Restorative_Locket.png",
            "price": 1600,
            "duration": "",
            "effects": [
                "TechResist: 10",
        ...
        },
        {
            ...
            "translated": "リターンファイア",
            "image": "images/items/30px-Return_Fire.png",
            "price": 1600,
            "duration": 6,
            "effects": [
                "BulletResist: 16",
        ...
        },
        {
            ...
            "image": "images/items/30px-Spirit_Lifesteal_(item).png",
            "price": 1600,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Spirit_Shielding.png",
            "price": 1600,
            "duration": "",
            "effects": [
                "OutOfCombatHealthRegen: 3",
            ...
            "description": "短時間内に敵から一定以上のSpiritDamageを受けると、バリアを獲得する"
        },
        {
            "id": "upgrade_weapon_shielding",
            "original": "Weapon Shielding",
            "translated": "ウェポンシールド",
            "image": "images/items/30px-Weapon_Shielding.png",
            "price": 1600,
            "duration": "",
            "effects": [
                "OutOfCombatHealthRegen: 3",
            ...
            "description": "短時間内に敵から一定以上のWeaponDamageを受けると、バリアを獲得する"
        },
        {
            "id": "upgrade_improved_bullet_armor",
            "original": "Bullet Resilience",
            "translated": "バレットレジリエンス",
            "image": "images/items/30px-Bullet_Resilience.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "BulletResist: 10",
            ...
            "description": "自身のHPが[HealthThreshold]%を下回っている間、追加の弾薬耐性を獲得する"
        },
        {
            "id": "upgrade_counterspell",
            "original": "Counterspell",
            "translated": "カウンタースペル",
            "image": "images/items/30px-Counterspell.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "SpiritPower: 20",
            ...
            "description": "次のパリィがダメージを防ぎ、敵のアビリティやアイテムによる効果を防ぐようになる。スペルパリィに成功するとHPをHealし、MoveSpeedとSpiritを獲得する"
        },
        {
            "id": "upgrade_reduce_debuff_duration",
            "original": "Dispel Magic",
            "translated": "ディスペルマジック",
            "image": "images/items/30px-Dispel_Magic.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "HealOnActivate: 150",
        ...
        },
        {
            ...
            "image": "images/items/30px-Fortitude.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "RestoreDelay: -6",
        ...
        },
        {
            ...
            "image": "images/items/30px-Fury_Trance.png",
            "price": 3200,
            "duration": 6,
            "effects": [
        ...
        },
        {
            ...
            "translated": "ヒーリングノヴァ",
            "image": "images/items/30px-Healing_Nova.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "TechRadiusMultiplier: 12",
        ...
        },
        {
            ...
            "original": "Lifestrike",
            "translated": "ライフストライク",
            "image": "images/items/30px-Lifestrike.png",
            "price": 3200,
            "duration": "",
            "effects": [
            ...
            "description": "近接攻撃時、対象にスロウを付与し、与えた近接ダメージの一定割合に固定値を加えた分のHPを回復する非ヒーローに対しては総回復量が[NonHeroHealPct]%に低下する近接弱攻撃の場合はクールダウンが[LightMeleeCooldownMult]倍になる"
        },
        {
            "id": "upgrade_rocket_booster",
            "original": "Majestic Leap",
            "translated": "マジェスティックリープ",
            "image": "images/items/30px-Majestic_Leap.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "AbilityCooldown: -35",
            ...
            "description": "空中高くに自身を射出し、バリアを獲得する。空中で再発動することで急降下できる敵ヒーローからダメージを受けてから[InterruptCooldown]秒間は使用できない"
        },
        {
            "id": "upgrade_metal_skin",
            "original": "Metal Skin",
            "translated": "メタルスキン",
            "image": "images/items/30px-Metal_Skin.png",
            "price": 3200,
            "duration": 5,
            "effects": [
        ...
        },
        {
            ...
            "translated": "レスキュービーム",
            "image": "images/items/30px-Rescue_Beam.png",
            "price": 3200,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Spirit_Resilience.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "TechResist: 10",
            ...
            "description": "自身のHPが[HealthThreshold]%を下回っている間、追加のスピリット耐性を獲得する"
        },
        {
            "id": "upgrade_superior_stamina",
            "original": "Stamina Mastery",
            "translated": "スタミナマスタリー",
            "image": "images/items/30px-Stamina_Mastery.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "Stamina: 2",
        ...
        },
        {
            ...
            "image": "images/items/30px-Trophy_Collector.png",
            "price": 3200,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "translated": "ベールウォーカー",
            "image": "images/items/30px-Veil_Walker.png",
            "price": 3200,
            "duration": 16,
            "effects": [
                "SpiritPower: 25",
        ...
        },
        {
            ...
            "original": "Warp Stone",
            "translated": "ワープストーン",
            "image": "images/items/30px-Warp_Stone.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "BulletResist: 20",
        ...
        },
        {
            ...
            "translated": "デスチーター",
            "image": "images/items/30px-Cheat_Death.png",
            "price": 6400,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "original": "Colossus",
            "translated": "コロッサス",
            "image": "images/items/30px-Colossus.png",
            "price": 6400,
            "duration": 7,
            "effects": [
                "BonusHealth: 700",
            ...
            "description": "サイズが大きくなり、BulletResist、SpiritResist、MeleeDamageを獲得する付近にいる敵はSlow状態になり、ダッシュ速度が低下する"
        },
        {
            "id": "upgrade_divine_barrier",
            "original": "Divine Barrier",
            "translated": "ディバインバリア",
            "image": "images/items/30px-Divine_Barrier.png",
            "price": 6400,
            "duration": "",
            "effects": [
                "AbilityCooldown: -27",
        ...
        },
        {
            ...
            "image": "images/items/30px-Diviner's_Kevlar.png",
            "price": 6400,
            "duration": "",
            "effects": [
                "BonusAbilityDurationPercent: 15",
        ...
        },
        {
            ...
            "translated": "ヒーリングテンポ",
            "image": "images/items/30px-Healing_Tempo.png",
            "price": 6400,
            "duration": "",
            "effects": [
            ...
            "description": "自分自身か味方のHPをHealすると、その対象にBonusFireRateとBonusMoveSpeedを付与するヒーローが元から有しているリジェネやパッシブの弾薬／スピリットライフスティールには適用されない"
        },
        {
            "id": "upgrade_infuser",
            "original": "Infuser",
            "translated": "インフューザー",
            "image": "images/items/30px-Infuser.png",
            "price": 6400,
            "duration": 6,
            "effects": [
                "AbilityCooldown: -10",
        ...
        },
        {
            ...
            "original": "Inhibitor",
            "translated": "インヒビター",
            "image": "images/items/30px-Inhibitor.png",
            "price": 6400,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "original": "Juggernaut",
            "translated": "ジャガーノート",
            "image": "images/items/30px-Juggernaut.png",
            "price": 6400,
            "duration": "",
            "effects": [
                "BonusMoveSpeed: 3.5m",
        ...
        },
        {
            ...
            "original": "Leech",
            "translated": "ライフドレイン",
            "image": "images/items/30px-Leech.png",
            "price": 6400,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Phantom_Strike.png",
            "price": 6400,
            "duration": "",
            "effects": [
                "TechPower: 12",
        ...
        },
        {
            ...
            "translated": "プレートアーマー",
            "image": "images/items/30px-Plated_Armor.png",
            "price": 6400,
            "duration": "",
            "effects": [
            ...
            "description": "一定確率で弾薬による攻撃を逸らす。弾薬を逸らした場合、WeaponDamageをすべて無効化するか、その弾薬によるヒット時効果をすべて無効化する"
        },
        {
            "id": "upgrade_siphon_bullets",
            "original": "Siphon Bullets",
            "translated": "サイフォンバレット",
            "image": "images/items/30px-Siphon_Bullets.png",
            "price": 6400,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "translated": "スペルブレイカー",
            "image": "images/items/30px-Spellbreaker.png",
            "price": 6400,
            "duration": "",
            "effects": [
                "TechResist: 15",
        ...
        },
        {
            ...
            "translated": "アンストッパブル",
            "image": "images/items/30px-Unstoppable.png",
            "price": 6400,
            "duration": 5.5,
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Vampiric_Burst.png",
            "price": 6400,
            "duration": 4.5,
            "effects": [
                "ActiveBonusFireRate: 25",
        ...
        },
        {
            ...
            "original": "Witchmail",
            "translated": "ウィッチメイル",
            "image": "images/items/30px-Witchmail.png",
            "price": 6400,
            "duration": "",
            "effects": [
                "TechPower: 26",
            ...
            "description": "敵から大きなSpiritDamageを受けると、ランダムなアビリティのクールダウンを短縮する"
        },
        {
            "id": "upgrade_celestial_guidance",
            "original": "Celestial Blessing",
            "translated": "天の祝福",
            "image": "images/items/30px-Celestial_Blessing.png",
            "price": "Legendary",
            "duration": "",
            "effects": [
                "AbilityCooldown: -20",
        ...
        },
        {
            ...
            "translated": "加護のマント",
            "image": "images/items/30px-Cloak_of_Opportunity.png",
            "price": "Legendary",
            "duration": "",
            "effects": [
                "BonusMoveSpeed: 4m",
            ...
            "description": "次に付与されるスタン、束縛、移動不能、睡眠のいずれかのデバフを無効化し、アンストッパブル状態になる。さらに、バリアとMoveSpeedボーナスを獲得する"
        },
        {
            "id": "upgrade_electric_slippers",
            "original": "Electric Slippers",
            "translated": "エレクトリックブーツ",
            "image": "images/items/30px-Electric_Slippers.png",
            "price": "Legendary",
            "duration": "",
            "effects": [
                "Stamina: 2",
        ...
        },
        {
            ...
            "translated": "エターナルギフト",
            "image": "images/items/30px-Eternal_Gift.png",
            "price": "Legendary",
            "duration": "",
            "effects": [
                "BuffFrequency: -0.5"
        ...
        },
        {
            ...
            "translated": "虚無の波動",
            "image": "images/items/30px-Nullification_Burst.png",
            "price": "Legendary",
            "duration": 7,
            "effects": [
                "EndRadius: 6m",
        ...
        },
        {
            ...
            "image": "images/items/30px-Seraphim_Wings.png",
            "price": "Legendary",
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Shadow_Strike.png",
            "price": "Legendary",
            "duration": 3,
            "effects": [
                "Stamina: 1",
    ...
    "spirit": [
        {
            ...
            "image": "images/items/30px-Extra_Charge.png",
            "price": 800,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Extra_Spirit.png",
            "price": 800,
            "duration": "",
            "effects": [
                "TechPower: 10"
        ...
        },
        {
            ...
            "image": "images/items/30px-Golden_Goose_Egg.png",
            "price": 800,
            "duration": "",
            "effects": [
                "BonusSprintSpeed: 5",
        ...
        },
        {
            ...
            "image": "images/items/30px-Mystic_Burst.png",
            "price": 800,
            "duration": "",
            "effects": [
                "Damage: 60"
            ...
            "description": "時間経過でBonusSpiritDamageをチャージする。アビリティで[MinimumDamage]を超えるダメージを与えると、追加ダメージを与える"
        },
        {
            "id": "upgrade_magic_reach",
            "original": "Mystic Expansion",
            "translated": "ミスティックエクスパンダー",
            "image": "images/items/30px-Mystic_Expansion.png",
            "price": 800,
            "duration": "",
            "effects": [
                "TechRadiusMultiplier: 15",
        ...
        },
        {
            ...
            "image": "images/items/30px-Mystic_Regeneration.png",
            "price": 800,
            "duration": "",
            "effects": [
                "Regeneration: 8",
        ...
        },
        {
            ...
            "translated": "コロッシブバレル",
            "image": "images/items/30px-Rusted_Barrel.png",
            "price": 800,
            "duration": 5,
            "effects": [
                "BonusHealth: 130",
        ...
        },
        {
            ...
            "image": "images/items/30px-Spirit_Strike.png",
            "price": 800,
            "duration": 6,
            "effects": [
                "SpiritDamage: 80",
            ...
            "description": "ヒーローに対して近接弱攻撃か近接強攻撃を行うと、追加でスピリットダメージを与え、対象のスピリット耐性を低下させる近接弱攻撃の場合はクールダウンが[LightMeleeCooldownMult]倍になる"
        },
        {
            "id": "upgrade_arcane_surge",
            "original": "Arcane Surge",
            "translated": "アーケインサージ",
            "image": "images/items/30px-Arcane_Surge.png",
            "price": 1600,
            "duration": 7,
            "effects": [
                "Stamina: 1",
            ...
            "description": "ダッシュジャンプすると、次に使用するアビリティの範囲と継続時間、スピリットパワーが強化される。この効果は最大で[AbilityDuration]秒間継続する"
        },
        {
            "id": "upgrade_bullet_resist_shredder",
            "original": "Bullet Resist Shredder",
            "translated": "レジストシュレッダー",
            "image": "images/items/30px-Bullet_Resist_Shredder.png",
            "price": 1600,
            "duration": 8,
            "effects": [
                "BulletResist: 7",
        ...
        },
        {
            ...
            "original": "Cold Front",
            "translated": "コールドフロント",
            "image": "images/items/30px-Cold_Front.png",
            "price": 1600,
            "duration": 4,
            "effects": [
                "TechResist: 8",
        ...
        },
        {
            ...
            "translated": "コンプレッサー",
            "image": "images/items/30px-Compress_Cooldown.png",
            "price": 1600,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "translated": "エクステンダー",
            "image": "images/items/30px-Duration_Extender.png",
            "price": 1600,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Improved_Spirit.png",
            "price": 1600,
            "duration": "",
            "effects": [
                "TechPower: 22",
        ...
        },
        {
            ...
            "image": "images/items/30px-Mystic_Slow.png",
            "price": 1600,
            "duration": 2,
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Mystic_Vulnerability.png",
            "price": 1600,
            "duration": 7,
            "effects": [
                "TechResist: 8",
        ...
        },
        {
            ...
            "image": "images/items/30px-Quicksilver_Reload.png",
            "price": 1600,
            "duration": "",
            "effects": [
                "BonusFireRate: 20",
            ...
            "description": "エンチャントしたアビリティを時間経過でチャージする。チャージ状態のアビリティは使用時にBonusSpiritDamageを与え、BonusFireRateを獲得して弾数をリロードする"
        },
        {
            "id": "upgrade_containment",
            "original": "Slowing Hex",
            "translated": "スロウヘックス",
            "image": "images/items/30px-Slowing_Hex.png",
            "price": 1600,
            "duration": 3.5,
            "effects": [
                "SlowPercent: 10",
        ...
        },
        {
            ...
            "image": "images/items/30px-Spirit_Sap.png",
            "price": 1600,
            "duration": 12,
            "effects": [
                "BonusHealth: 150",
        ...
        },
        {
            ...
            "original": "Suppressor",
            "translated": "サプレッサー",
            "image": "images/items/30px-Suppressor.png",
            "price": 1600,
            "duration": 5,
            "effects": [
                "TechPower: 12",
        ...
        },
        {
            ...
            "original": "Decay",
            "translated": "ディケイ",
            "image": "images/items/30px-Decay.png",
            "price": 3200,
            "duration": 10,
            "effects": [
                "TechPower: 12",
        ...
        },
        {
            ...
            "image": "images/items/30px-Disarming_Hex.png",
            "price": 3200,
            "duration": 4,
            "effects": [
                "BonusHealth: 175",
        ...
        },
        {
            ...
            "image": "images/items/30px-Greater_Expansion.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "TechResist: 10",
        ...
        },
        {
            ...
            "original": "Knockdown",
            "translated": "ノックダウン",
            "image": "images/items/30px-Knockdown.png",
            "price": 3200,
            "duration": "",
            "effects": [
            ...
            "description": "[StunDelay]秒のディレイ後に対象をスタンさせる。空中にいる対象に対してはスタン継続時間が増加するスタン状態の間、対象にかかる重力を増加させる"
        },
        {
            "id": "upgrade_resonant_healing",
            "original": "Radiant Regeneration",
            "translated": "ラディアントリジェネ",
            "image": "images/items/30px-Radiant_Regeneration.png",
            "price": 3200,
            "duration": 3,
            "effects": [
                "Regeneration: 9",
        ...
        },
        {
            ...
            "image": "images/items/30px-Rapid_Recharge.png",
            "price": 3200,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Silence_Wave.png",
            "price": 3200,
            "duration": 3,
            "effects": [
                "AbilityCooldown: -10",
        ...
        },
        {
            ...
            "image": "images/items/30px-Spirit_Snatch.png",
            "price": 3200,
            "duration": 10,
            "effects": [
                "SpiritDamage: 50",
            ...
            "description": "ヒーローに対して近接弱攻撃か近接強攻撃を行うと、追加でスピリットダメージを与え、対象のスピリット耐性とスピリットパワーを吸収する近接弱攻撃の場合は効果量が[LightMeleeScale]%に減少する"
        },
        {
            "id": "upgrade_cooldown_reduction",
            "original": "Superior Cooldown",
            "translated": "クールダウンブースト",
            "image": "images/items/30px-Superior_Cooldown.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "CooldownReduction: 10",
        ...
        },
        {
            ...
            "image": "images/items/30px-Superior_Duration.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "BonusAbilityDurationPercent: 12",
        ...
        },
        {
            ...
            "translated": "パワーサージ",
            "image": "images/items/30px-Surge_of_Power.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "ImbuedTechPower: 32",
        ...
        },
        {
            ...
            "original": "Tankbuster",
            "translated": "タンクバスター",
            "image": "images/items/30px-Tankbuster.png",
            "price": 3200,
            "duration": "",
            "effects": [
            ...
            "description": "時間経過でBonusSpiritDamageをチャージする。アビリティで[MinimumDamage]を超えるダメージを与えると、追加ダメージを与える。スピリット耐性を無視する"
        },
        {
            "id": "upgrade_tech_damage_pulse",
            "original": "Torment Pulse",
            "translated": "トーメントパルス",
            "image": "images/items/30px-Torment_Pulse.png",
            "price": 3200,
            "duration": "",
            "effects": [
                "BonusHealth: 75",
        ...
        },
        {
            ...
            "image": "images/items/30px-Arctic_Blast.png",
            "price": 6400,
            "duration": "",
            "effects": [
                "Damage: 150",
        ...
        },
        {
            ...
            "image": "images/items/30px-Boundless_Spirit.png",
            "price": 6400,
            "duration": "",
            "effects": [
                "TechPower: 25",
        ...
        },
        {
            ...
            "translated": "呪いの遺物",
            "image": "images/items/30px-Cursed_Relic.png",
            "price": 6400,
            "duration": 3.25,
            "effects": [
                "AbilityCooldown: -40",
        ...
        },
        {
            ...
            "original": "Echo Shard",
            "translated": "エコーシャード",
            "image": "images/items/30px-Echo_Shard.png",
            "price": 6400,
            "duration": "",
            "effects": [
                "BulletResist: 5",
        ...
        },
        {
            ...
            "translated": "エクスポージャー",
            "image": "images/items/30px-Escalating_Exposure.png",
            "price": 6400,
            "duration": 12,
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Ethereal_Shift.png",
            "price": 6400,
            "duration": 4,
            "effects": [
                "AbilityDuration: 2",
        ...
        },
        {
            ...
            "original": "Focus Lens",
            "translated": "フォーカスレンズ",
            "image": "images/items/30px-Focus_Lens.png",
            "price": 6400,
            "duration": 4,
            "effects": [
                "PercentDamage: 20",
        ...
        },
        {
            ...
            "image": "images/items/30px-Lightning_Scroll.png",
            "price": 6400,
            "duration": 2,
            "effects": [
                "BonusHealth: 100",
            ...
            "description": "アルティメットでダメージを与えると、短いディレイ後にStunを付与し、BonusSpiritDamageを与える"
        },
        {
            "id": "upgrade_magic_carpet",
            "original": "Magic Carpet",
            "translated": "マジックカーペット",
            "image": "images/items/30px-Magic_Carpet.png",
            "price": 6400,
            "duration": 12,
            "effects": [
                "TechPower: 46",
        ...
        },
        {
            ...
            "image": "images/items/30px-Mercurial_Magnum.png",
            "price": 6400,
            "duration": "",
            "effects": [
                "BonusFireRate: 20",
            ...
            "description": "エンチャントしたアビリティを時間経過でチャージする。チャージ状態のアビリティは使用時にBonusSpiritDamageを与え、BonusFireRateを獲得し、弾薬をリロードする。また、次にリロードするまで、スピリットパワーに応じた追加スピリットダメージを弾薬が与えるようになる"
        },
        {
            "id": "upgrade_mystic_reverb",
            "original": "Mystic Reverb",
            "translated": "ミスティックリバーブ",
            "image": "images/items/30px-Mystic_Reverb.png",
            "price": 6400,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "original": "Refresher",
            "translated": "リフレッシャー",
            "image": "images/items/30px-Refresher.png",
            "price": 6400,
            "duration": "",
            "effects": [
                "AbilityCooldown: -210"
        ...
        },
        {
            ...
            "original": "Scourge",
            "translated": "スカージ",
            "image": "images/items/30px-Scourge.png",
            "price": 6400,
            "duration": 10,
            "effects": [
            ...
            "description": "指定した味方にスピリット耐性とオーラを付与する。オーラは最大HPに応じたSpiritIconダメージダメージを与えるこのアイテムはセルフキャストできる"
        },
        {
            "id": "upgrade_spirit_burn",
            "original": "Spirit Burn",
            "translated": "スピリットバーン",
            "image": "images/items/30px-Spirit_Burn.png",
            "price": 6400,
            "duration": "",
            "effects": [
                "ExplosionDamage: 160",
            ...
            "description": "敵に対して[DamageThresholdDuration]秒以内に一定以上のスピリットダメージを与えると、ダメージを与える爆発を発生させ、付近にいる敵に燃焼を付与する。燃焼状態の敵は継続ダメージを受け、被回復量が低下する非ヒーローに対しては与えるダメージとクールダウンが半減する"
        },
        {
            "id": "upgrade_transcendent_cooldown",
            "original": "Transcendent Cooldown",
            "translated": "トランセンデント",
            "image": "images/items/30px-Transcendent_Cooldown.png",
            "price": 6400,
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "image": "images/items/30px-Vortex_Web.png",
            "price": 6400,
            "duration": 4,
            "effects": [
                "BonusSprintSpeed: 9m",
        ...
        },
        {
            ...
            "translated": "凍傷のチャーム",
            "image": "images/items/30px-Frostbite_Charm.png",
            "price": "Legendary",
            "duration": "",
            "effects": [
                "AbilityCooldown: -2",
        ...
        },
        {
            ...
            "image": "images/items/30px-Mystic_Conduit.png",
            "price": "Legendary",
            "duration": "",
            "effects": [
                "TechRadiusMultiplier: 10",
        ...
        },
        {
            ...
            "image": "images/items/30px-Mystical_Piano.png",
            "price": "Legendary",
            "duration": 1.7,
            "effects": [
                "AbilityCooldown: -15",
        ...
        },
        {
            ...
            "translated": "オムニチャージ",
            "image": "images/items/30px-Omnicharge_Signet.png",
            "price": "Legendary",
            "duration": "",
            "effects": [
                "BonusAbilityCharges: 2",
        ...
        },
        {
            ...
            "translated": "プリズムブラスト",
            "image": "images/items/30px-Prism_Blast.png",
            "price": "Legendary",
            "duration": 6,
            "effects": [
                "AbilityDuration: 2",
        ...
        },
        {
            ...
            "original": "Shrink Ray",
            "translated": "シュリンクレイ",
            "image": "images/items/30px-Shrink_Ray.png",
            "price": "Legendary",
            "duration": "",
            "effects": [
        ...
        },
        {
            ...
            "translated": "不安定な調合薬",
            "image": "images/items/30px-Unstable_Concoction.png",
            "price": "Legendary",
            "duration": 4,
            "effects": [
                "StunDuration: 0.5",
